...
public class PageCreator {
	...
	public PageCreator(IGame inputGame) {
		this.game = inputGame;
	}
	...
	private void createMainPage() {
		...
		tempStringHead += "<link rel=\'icon\' type=\'image/png\' href=\'pages/resources/favicon.png\'/>" + "\n";
		...
		tempStringBody += "<body text=\'#8B4513\' bgcolor=\'gray\' background = \'pages/resources/background.png\'>"
				+ "\n";

		// Разметка контента и запонение;
		tempStringBody += "<div align=\'center\'>" + "\n";
		tempStringBody += "<table width=\'890px\' height=\'810px\' background=\'pages/resources/tablebg.png\'>" + "\n";
	...
	private void createFirstPlayerPage() {
		...
		tempStringBody += "<img align=\'left\' width=\'300px\'" + " height=\'300px\'" + " alt=\'Player Avatar\'"
				+ " src=\'pages/resources/avatars/avatar" + (digitRanfom()) + ".png\'>" + "\n";
	...
	private String classifierFigures(FigureType figureType) {
		if (figureType == null) {
			return "pages/resources/figures/null.png";
		}
		switch (figureType) {
		case BLACK_PAWN: {
			return "pages/resources/figures/bpawn.png";
		}
		case BLACK_ROOK: {
			return "pages/resources/figures/brook.png";
		}
		case BLACK_KNIGHT: {
			return "pages/resources/figures/bknight.png";
		}
		case BLACK_BISHOP: {
			return "pages/resources/figures/bbishop.png";
		}
		case BLACK_QUEEN: {
			return "pages/resources/figures/bqueen.png";
		}
		case BLACK_KING: {
			return "pages/resources/figures/bking.png";
		}
		case WHITE_PAWN: {
			return "pages/resources/figures/wpawn.png";
		}
		case WHITE_ROOK: {
			return "pages/resources/figures/wrook.png";
		}
		case WHITE_KNIGHT: {
			return "pages/resources/figures/wknight.png";
		}
		case WHITE_BISHOP: {
			return "pages/resources/figures/wbishop.png";
		}
		case WHITE_QUEEN: {
			return "pages/resources/figures/wqueen.png";
		}
		case WHITE_KING: {
			return "pages/resources/figures/wking.png";
		}
		default: {
			return "";
		}
	...
	private void savePage(String string, String namePage) {
		try {
			File file = new File("./web/" + namePage + ".html");
			FileWriter writer = new FileWriter(file, false);
			writer.write(string);
			writer.flush();
			writer.close();
			System.out.println("[Файл " + namePage + ".html создан]");
		} catch (IOException e) {
